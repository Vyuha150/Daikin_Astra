...
Requirement: ${formData.requirement}`;
    ...
    const whatsappUrl = `https://wa.me/919247041999?text=${encodeURIComponent(
      message
    )}`;
  ...
  return (
    <section
      id="contact"
      className="py-16 lg:py-24 bg-gradient-to-br from-primary/5 to-accent/10"
    >
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Expert consultation, free quotes, and professional installation
            services across Vijayawada
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Your trusted Daikin authorized dealer with 15+ years of
                experience in HVAC solutions. We provide complete AC services
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={index}
                  className="bg-gradient-to-r from-primary/5 to-accent/5 backdrop-blur-sm border border-white/20 rounded-xl p-6 group relative overflow-hidden"
                >
            ...
            {/* Service Areas */}
            <div className="rounded-lg p-6 bg-gradient-to-r from-primary/5 to-accent/5 border">
          ...
          <div className="bg-gradient-to-r from-primary/5 to-accent/5 backdrop-blur-sm border border-white/20 rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-sm text-white/80 text-center">
                * Required fields. Your inquiry will be sent via WhatsApp for
                quick response.
              </p>
            </form>
          </div>
