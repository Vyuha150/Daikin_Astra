      ...
      <div className="container mx-auto px-4 lg:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Real experiences from satisfied customers across Vijayawada and
            surrounding areas
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-black/20 p-8 lg:p-12 text-center relative">
            {/* Quote Icon */}
            ...
            {/* Testimonial Text */}
            <blockquote className="text-xl lg:text-2xl text-accent mb-8 italic font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={index}
              className="rounded-lg card-hover bg-black/20 backdrop-blur-sm border border-white/10 relative group"
            >
              <div className=" p-6 h-full text-center relative overflow-hidden">
                {/* Animated background */}
                <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                <div className="relative z-10">
                  <div className="text-4xl lg:text-5xl font-heading font-bold text-gradient bg-black mb-3 group-hover:scale-110 transition-transform duration-300">
                    {stat.number}
                  </div>
        ...
        <div className="text-center mt-12">
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                "https://wa.me/919247041999?text=Hi! I want to know more about your AC services",
                "_blank"
              )
            }
          >
